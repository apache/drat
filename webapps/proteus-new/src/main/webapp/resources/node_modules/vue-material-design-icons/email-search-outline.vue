<template>
  <span class="material-design-icon email-search-outline-icon"
...
<script>
  export default {
    name: "email-search-outline-icon",
    props: {
      title: {
        type: String,
