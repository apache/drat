<template>
  <span class="material-design-icon lightbulb-on-outline-icon"
...
<script>
  export default {
    name: "lightbulb-on-outline-icon",
    props: {
      title: {
        type: String,
