<template>
  <span class="material-design-icon microphone-variant-off-icon"
...
<script>
  export default {
    name: "microphone-variant-off-icon",
    props: {
      title: {
        type: String,
