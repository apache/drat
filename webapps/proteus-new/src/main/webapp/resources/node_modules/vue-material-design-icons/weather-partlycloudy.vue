<template>
  <span class="material-design-icon weather-partlycloudy-icon"
...
<script>
  export default {
    name: "weather-partlycloudy-icon",
    props: {
      title: {
        type: String,
