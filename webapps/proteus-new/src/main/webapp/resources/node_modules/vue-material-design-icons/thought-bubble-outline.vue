<template>
  <span class="material-design-icon thought-bubble-outline-icon"
...
<script>
  export default {
    name: "thought-bubble-outline-icon",
    props: {
      title: {
        type: String,
