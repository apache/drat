<template>
  <span class="material-design-icon google-circles-group-icon"
...
<script>
  export default {
    name: "google-circles-group-icon",
    props: {
      title: {
        type: String,
