<template>
  <span class="material-design-icon battery-bluetooth-variant-icon"
...
<script>
  export default {
    name: "battery-bluetooth-variant-icon",
    props: {
      title: {
        type: String,
