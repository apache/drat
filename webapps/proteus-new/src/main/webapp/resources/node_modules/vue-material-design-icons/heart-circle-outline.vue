<template>
  <span class="material-design-icon heart-circle-outline-icon"
...
<script>
  export default {
    name: "heart-circle-outline-icon",
    props: {
      title: {
        type: String,
