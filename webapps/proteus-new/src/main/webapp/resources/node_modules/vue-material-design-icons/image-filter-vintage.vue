<template>
  <span class="material-design-icon image-filter-vintage-icon"
...
<script>
  export default {
    name: "image-filter-vintage-icon",
    props: {
      title: {
        type: String,
