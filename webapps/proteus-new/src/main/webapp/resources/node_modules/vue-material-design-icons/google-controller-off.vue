<template>
  <span class="material-design-icon google-controller-off-icon"
...
<script>
  export default {
    name: "google-controller-off-icon",
    props: {
      title: {
        type: String,
