<template>
  <span class="material-design-icon account-card-details-icon"
...
<script>
  export default {
    name: "account-card-details-icon",
    props: {
      title: {
        type: String,
