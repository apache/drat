<template>
  <span class="material-design-icon television-classic-off-icon"
...
<script>
  export default {
    name: "television-classic-off-icon",
    props: {
      title: {
        type: String,
