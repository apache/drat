<template>
  <span class="material-design-icon weather-lightning-rainy-icon"
...
<script>
  export default {
    name: "weather-lightning-rainy-icon",
    props: {
      title: {
        type: String,
