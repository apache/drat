<template>
  <span class="material-design-icon google-circles-extended-icon"
...
<script>
  export default {
    name: "google-circles-extended-icon",
    props: {
      title: {
        type: String,
