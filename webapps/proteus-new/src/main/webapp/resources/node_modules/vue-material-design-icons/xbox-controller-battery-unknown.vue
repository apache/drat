<template>
  <span class="material-design-icon xbox-controller-battery-unknown-icon"
...
<script>
  export default {
    name: "xbox-controller-battery-unknown-icon",
    props: {
      title: {
        type: String,
