<template>
  <span class="material-design-icon access-point-network-icon"
...
<script>
  export default {
    name: "access-point-network-icon",
    props: {
      title: {
        type: String,
