<template>
  <span class="material-design-icon youtube-creator-studio-icon"
...
<script>
  export default {
    name: "youtube-creator-studio-icon",
    props: {
      title: {
        type: String,
