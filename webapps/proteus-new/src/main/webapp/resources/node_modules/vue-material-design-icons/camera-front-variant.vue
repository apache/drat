<template>
  <span class="material-design-icon camera-front-variant-icon"
...
<script>
  export default {
    name: "camera-front-variant-icon",
    props: {
      title: {
        type: String,
