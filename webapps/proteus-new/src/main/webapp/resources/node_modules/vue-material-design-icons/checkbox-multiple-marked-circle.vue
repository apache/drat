<template>
  <span class="material-design-icon checkbox-multiple-marked-circle-icon"
...
<script>
  export default {
    name: "checkbox-multiple-marked-circle-icon",
    props: {
      title: {
        type: String,
