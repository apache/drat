<template>
  <span class="material-design-icon message-settings-variant-icon"
...
<script>
  export default {
    name: "message-settings-variant-icon",
    props: {
      title: {
        type: String,
