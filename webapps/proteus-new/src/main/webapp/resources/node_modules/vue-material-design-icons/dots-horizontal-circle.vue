<template>
  <span class="material-design-icon dots-horizontal-circle-icon"
...
<script>
  export default {
    name: "dots-horizontal-circle-icon",
    props: {
      title: {
        type: String,
