<template>
  <span class="material-design-icon account-multiple-outline-icon"
...
<script>
  export default {
    name: "account-multiple-outline-icon",
    props: {
      title: {
        type: String,
